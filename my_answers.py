...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        output_error_term = output_error * self.derivative_function(final_outputs)
        ...
        delta_weights_h_o += self.lr * np.dot(output_error_term, hidden_outputs)
        delta_weights_i_h += self.lr * np.dot(hidden_error_term.T, X)
